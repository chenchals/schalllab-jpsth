...
function [jpsthData] = jpsth_jer(n_1, n_2, coinWidth)
	...
	[covariogram,sigHigh,sigLow,shuffleCorrector,crossCorr] = covariogramBrody(n_1,n_2,psth_1,psth_2,psth_1_var,psth_2_var);
	...
	jpsthData = struct('psth_1',psth_1,'psth_2',psth_2, ...
                        ...
                        'brodyCrossCorr',crossCorr,...
                        'brodyShuffleCorrector',shuffleCorrector,...
						'sigLow',sigLow, ...
						'sigHigh',sigHigh, ...
